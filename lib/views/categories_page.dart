                        ...
                        onPressed: () {
                          ...
                          showDialog(
                            ...
                            builder: (context) => AdditionalConfirm(
                              ...
                              onYes: () {
                                DbService()
                                    .deleteCategories(docId: categories[index].id);
                                Navigator.pop(context);
                              },
                              onNo: () {
                                Navigator.pop(context);
          ...
          onPressed: () async {
            if (formKey.currentState!.validate()) {
              ...
              if (widget.isUpdating) {
                ...
                // Prompt for deletion after update
                showDialog(
                  context: context,
                  builder: (context) => AlertDialog(
                    title: Text("Delete Category"),
                    content: Text("Would you like to delete this category now?"),
                    actions: [
                      TextButton(
                        onPressed: () {
                          Navigator.pop(context); // Close the delete prompt
                          Navigator.pop(context); // Close ModifyCategory dialog
                        },
                        child: Text("No"),
                      ),
                      TextButton(
                        onPressed: () async {
                          // Perform deletion
                          await DbService().deleteCategories(docId: widget.categoryId);
                          adminProvider.getCategories(); // Refresh categories
                ...
                adminProvider.getCategories();
                Navigator.pop(context); // Close the ModifyCategory dialog
              }
            }
          },
